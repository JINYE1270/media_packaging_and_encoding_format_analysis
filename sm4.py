...
if __name__ == "__main__":
    ...
    file_path_cbc_enc_v = r"dec_videos/enc1.h264"
    ...
    de_data = sm4_d.sm4_crypt_cbc(iv_data, file_data_list)
    de_data_str = "".join([chr(x) for x in de_data])
    print "de_data: ", de_data, type(de_data)
    print "de_data: ",
    for d in de_data:
        print "%02x" % int(d),
    print ""
